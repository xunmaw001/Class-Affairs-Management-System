      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='banwei'" class="input-group">
			   <div class="label">班委账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.banweizhanghao" class="input" type="text" placeholder="班委账号">
			   </div>
			 </div> -->
			<el-form-item label="班委账号" class="input" v-if="tableName=='banwei'">
			  <el-input v-model="ruleForm.banweizhanghao" autocomplete="off" placeholder="班委账号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='banwei'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="确认密码" class="input" v-if="tableName=='banwei'">
			  <el-input v-model="ruleForm.mima2" autocomplete="off" placeholder="确认密码" type="password"/>
			</el-form-item>

			<!-- <div v-if="tableName=='banwei'" class="input-group">
			   <div class="label">班委姓名</div>
			   <div class="input-container">
			     <input v-model="ruleForm.banweixingming" class="input" type="text" placeholder="班委姓名">
			   </div>
			 </div> -->
			<el-form-item label="班委姓名" class="input" v-if="tableName=='banwei'">
			  <el-input v-model="ruleForm.banweixingming" autocomplete="off" placeholder="班委姓名"  />
			</el-form-item>
			<!-- <div v-if="tableName=='banwei'" class="input-group">
			   <div class="label">年龄</div>
			   <div class="input-container">
			...
			<el-form-item label="年龄" class="input" v-if="tableName=='banwei'">
			  <el-input v-model="ruleForm.nianling" autocomplete="off" placeholder="年龄"  />
			</el-form-item>
			<!-- <div v-if="tableName=='banwei'" class="input-group">
			   <div class="label">手机</div>
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if((!this.ruleForm.banweizhanghao) && `banwei` == this.tableName){
        this.$message.error(`班委账号不能为空`);
        return
      }
      ...
      if((this.ruleForm.mima!=this.ruleForm.mima2) && `banwei` == this.tableName){
	    this.$message.error(`两次密码输入不一致`);
	    return
      }
      if((!this.ruleForm.banweixingming) && `banwei` == this.tableName){
        this.$message.error(`班委姓名不能为空`);
        return
      }
      if(`banwei` == this.tableName && this.ruleForm.nianling&&(!this.$validate.isIntNumer(this.ruleForm.nianling))){
        this.$message.error(`年龄应输入整数`);
        return
      }
