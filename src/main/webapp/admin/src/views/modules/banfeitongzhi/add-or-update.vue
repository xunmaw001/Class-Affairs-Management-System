<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="班费" prop="banfei">
          <el-input v-model="ruleForm.banfei" 
              placeholder="班费" clearable  :readonly="ro.banfei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="班费" prop="banfei">
              <el-input v-model="ruleForm.banfei" 
                placeholder="班费" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="班委账号" prop="banweizhanghao">
          <el-input v-model="ruleForm.banweizhanghao" 
              placeholder="班委账号" clearable  :readonly="ro.banweizhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="班委账号" prop="banweizhanghao">
              <el-input v-model="ruleForm.banweizhanghao" 
                placeholder="班委账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="班委姓名" prop="banweixingming">
          <el-input v-model="ruleForm.banweixingming" 
              placeholder="班委姓名" clearable  :readonly="ro.banweixingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="班委姓名" prop="banweixingming">
              <el-input v-model="ruleForm.banweixingming" 
                placeholder="班委姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="通知日期" prop="tongzhiriqi">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.tongzhiriqi" label="通知日期" prop="tongzhiriqi">
              <el-input v-model="ruleForm.tongzhiriqi" 
                placeholder="通知日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="收缴原因" prop="shoujiaoyuanyin">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="收缴原因"
                  v-model="ruleForm.shoujiaoyuanyin" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.shoujiaoyuanyin" label="收缴原因" prop="shoujiaoyuanyin">
                    <span>{{ruleForm.shoujiaoyuanyin}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	banji : false,
	banfei : false,
	shoujiaoyuanyin : false,
	banweizhanghao : false,
	banweixingming : false,
	tongzhiriqi : false,
	ispay : false,
      },
      ruleForm: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.banji = true;
          ...
          if(o=='banfei'){
            this.ruleForm.banfei = obj[o];
	    this.ro.banfei = true;
            continue;
          }
          if(o=='shoujiaoyuanyin'){
            this.ruleForm.shoujiaoyuanyin = obj[o];
	    this.ro.shoujiaoyuanyin = true;
            continue;
          }
          if(o=='banweizhanghao'){
            this.ruleForm.banweizhanghao = obj[o];
	    this.ro.banweizhanghao = true;
            continue;
          }
          if(o=='banweixingming'){
            this.ruleForm.banweixingming = obj[o];
	    this.ro.banweixingming = true;
            continue;
          }
          if(o=='tongzhiriqi'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.banweizhanghao!=''&&json.banweizhanghao){
                this.ruleForm.banweizhanghao = json.banweizhanghao
	    		this.ro.banweizhanghao = true;
		}
		if(json.banweixingming!=''&&json.banweixingming){
                this.ruleForm.banweixingming = json.banweixingming
	    		this.ro.banweixingming = true;
		}
        } else {
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `banfeitongzhi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.banfeitongzhiCrossAddOrUpdateFlag = false;
						 this.parent.search();
