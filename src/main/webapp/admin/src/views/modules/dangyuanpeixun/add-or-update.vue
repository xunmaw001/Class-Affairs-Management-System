<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="培训时间" prop="peixunshijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.peixunshijian" 
                type="datetime"
                :readonly="ro.peixunshijian"
                placeholder="培训时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.peixunshijian" label="培训时间" prop="peixunshijian">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="培训天数" prop="peixuntianshu">
          <el-input v-model="ruleForm.peixuntianshu" 
              placeholder="培训天数" clearable  :readonly="ro.peixuntianshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="培训天数" prop="peixuntianshu">
              <el-input v-model="ruleForm.peixuntianshu" 
                placeholder="培训天数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="培训内容" prop="peixunneirong">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.peixunneirong" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.peixunneirong" label="培训内容" prop="peixunneirong">
                    <span v-html="ruleForm.peixunneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  created() {
	this.ruleForm.peixunshijian = this.getCurDateTime()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jieshushijian = true;
          ...
          if(o=='peixuntianshu'){
            this.ruleForm.peixuntianshu = obj[o];
	    this.ro.peixuntianshu = true;
            continue;
          }
          if(o=='fabushijian'){
	...
	this.ruleForm.peixunneirong = this.ruleForm.peixunneirong.replace(reg,'../../../ssmn2tzw/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `dangyuanpeixun/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.dangyuanpeixunCrossAddOrUpdateFlag = false;
						 this.parent.search();
