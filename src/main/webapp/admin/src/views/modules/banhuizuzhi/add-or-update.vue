<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="组织编号" prop="zuzhibianhao">
            <el-input v-model="ruleForm.zuzhibianhao" 
                placeholder="组织编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.zuzhibianhao" label="组织编号" prop="zuzhibianhao">
              <el-input v-model="ruleForm.zuzhibianhao" 
                placeholder="组织编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="组织名称" prop="zuzhimingcheng">
          <el-input v-model="ruleForm.zuzhimingcheng" 
              placeholder="组织名称" clearable  :readonly="ro.zuzhimingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="组织名称" prop="zuzhimingcheng">
              <el-input v-model="ruleForm.zuzhimingcheng" 
                placeholder="组织名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="创建人" prop="chuangjianren">
          <el-input v-model="ruleForm.chuangjianren" 
              placeholder="创建人" clearable  :readonly="ro.chuangjianren"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="创建人" prop="chuangjianren">
              <el-input v-model="ruleForm.chuangjianren" 
                placeholder="创建人" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="组织介绍" prop="zuzhijieshao">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.zuzhijieshao" label="组织介绍" prop="zuzhijieshao">
                    <span v-html="ruleForm.zuzhijieshao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  created() {
	this.ruleForm.chuangjianriqi = this.getCurDate()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.chuangjianriqi = true;
          ...
          if(o=='chuangjianren'){
            this.ruleForm.chuangjianren = obj[o];
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.zuzhimingcheng!=''&&json.zuzhimingcheng){
                this.ruleForm.zuzhimingcheng = json.zuzhimingcheng
	    		this.ro.zuzhimingcheng = true;
		}
		if(json.chuangjianren!=''&&json.chuangjianren){
                this.ruleForm.chuangjianren = json.chuangjianren
	    		this.ro.chuangjianren = true;
		}
	...
	this.ruleForm.zuzhijieshao = this.ruleForm.zuzhijieshao.replace(reg,'../../../ssmn2tzw/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `banhuizuzhi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.banhuizuzhiCrossAddOrUpdateFlag = false;
						 this.parent.search();
