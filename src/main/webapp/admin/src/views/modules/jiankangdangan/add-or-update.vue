<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="慢性急病" prop="manxingjibing">
          <el-select :disabled="ro.manxingjibing" v-model="ruleForm.manxingjibing" placeholder="请选择慢性急病">
            <el-option
                v-for="(item,index) in manxingjibingOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="慢性急病" prop="manxingjibing">
	      <el-input v-model="ruleForm.manxingjibing"
                placeholder="慢性急病" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="家族病史" prop="jiazubingshi">
          <el-select :disabled="ro.jiazubingshi" v-model="ruleForm.jiazubingshi" placeholder="请选择家族病史">
            <el-option
                v-for="(item,index) in jiazubingshiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="家族病史" prop="jiazubingshi">
	      <el-input v-model="ruleForm.jiazubingshi"
                placeholder="家族病史" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="药物过敏" prop="yaowuguomin">
          <el-select :disabled="ro.yaowuguomin" v-model="ruleForm.yaowuguomin" placeholder="请选择药物过敏">
            <el-option
                v-for="(item,index) in yaowuguominOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="重大病史" prop="zhongdabingshi">
          <el-select :disabled="ro.zhongdabingshi" v-model="ruleForm.zhongdabingshi" placeholder="请选择重大病史">
            <el-option
                v-for="(item,index) in zhongdabingshiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="重大病史" prop="zhongdabingshi">
	      <el-input v-model="ruleForm.zhongdabingshi"
                placeholder="重大病史" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="日常饮食" prop="richangyinshi">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="日常饮食"
                  v-model="ruleForm.richangyinshi" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.richangyinshi" label="日常饮食" prop="richangyinshi">
                    <span>{{ruleForm.richangyinshi}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
	...
	dengjiriqi : false,
      ...
      ruleForm: {
        ...
        dengjiriqi: '',
          ...
          manxingjibingOptions: [],
          jiazubingshiOptions: [],
          yaowuguominOptions: [],
          zhongdabingshiOptions: [],
      rules: {
          xuehao: [
          ],
          xingming: [
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yaowuguomin = true;
          ...
          if(o=='zhongdabingshi'){
            this.ruleForm.zhongdabingshi = obj[o];
	    this.ro.zhongdabingshi = true;
            continue;
          }
          if(o=='richangyinshi'){
            this.ruleForm.richangyinshi = obj[o];
	    this.ro.richangyinshi = true;
            continue;
          }
          if(o=='beizhu'){
      ...
      this.$http({
		...
		if(json.xingbie!=''&&json.xingbie){
          ...
          this.$message.error(data.msg);
            ...
            this.manxingjibingOptions = "有,无".split(',')
            this.jiazubingshiOptions = "有,无".split(',')
            this.yaowuguominOptions = "有,无".split(',')
            this.zhongdabingshiOptions = "有,无".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
