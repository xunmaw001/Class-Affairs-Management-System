    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
        <el-row  :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                <el-form-item :label="contents.inputTitle == 1 ? '班委账号' : ''">
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1" prefix-icon="el-icon-search" v-model="searchForm.banweizhanghao" placeholder="班委账号" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2" suffix-icon="el-icon-search" v-model="searchForm.banweizhanghao" placeholder="班委账号" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 0" v-model="searchForm.banweizhanghao" placeholder="班委账号" clearable></el-input>
                </el-form-item>
                <el-form-item :label="contents.inputTitle == 1 ? '班委姓名' : ''">
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1" prefix-icon="el-icon-search" v-model="searchForm.banweixingming" placeholder="班委姓名" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2" suffix-icon="el-icon-search" v-model="searchForm.banweixingming" placeholder="班委姓名" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 0" v-model="searchForm.banweixingming" placeholder="班委姓名" clearable></el-input>
                </el-form-item>
    ...
    getDataList() {
      ...
      let params = {
        ...
        sort: 'id',
          ...
          if(this.searchForm.banweizhanghao!='' && this.searchForm.banweizhanghao!=undefined){
            params['banweizhanghao'] = '%' + this.searchForm.banweizhanghao + '%'
          }
          if(this.searchForm.banweixingming!='' && this.searchForm.banweixingming!=undefined){
            params['banweixingming'] = '%' + this.searchForm.banweixingming + '%'
          }
