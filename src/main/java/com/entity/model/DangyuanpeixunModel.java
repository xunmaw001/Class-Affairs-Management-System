 ...
 */
public class DangyuanpeixunModel  implements Serializable {
	...
	public void setPeixuntianshu(Integer peixuntianshu) {
	 ...
	 * 获取：培训天数
	 */
	public Integer getPeixuntianshu() {
